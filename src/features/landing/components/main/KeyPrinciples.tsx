...
const principles = [
  {
    ...
    description: 'Understanding attention, decision-making, and information processing'
  },
  {
    icon: '⚡',
    title: 'System Design',
    description: 'Creating interfaces that reduce friction and build confidence'
  },
  {
    icon: '🔬',
    title: 'Technical Excellence',
    description: 'From backend data to frontend interfaces, every layer optimized'
  }
]
